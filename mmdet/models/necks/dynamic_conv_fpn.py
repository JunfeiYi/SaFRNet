...
from .dyconv_wrappers0 import Conv2d
from .dyconv_batch_norm0 import get_activation, get_norm

#from mmcv.ops import masked_conv2d
from .dyconv_masked_conv0 import masked_conv2d
...
class BasicBlock(nn.Module):
    ...
    def masked_inference(self, x, gate):
        ...
        out = masked_conv2d(x.contiguous(), gate_max.squeeze(dim=1), self.conv1.weight,
