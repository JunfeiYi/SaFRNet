...
class PAACOSHead(ATSSHead):
    ...
    def __init__(self,
        ...
        super(PAACOSHead, self).__init__(*args, **kwargs)
    ...
    def _init_layers(self):
        ...
        self.cls_pac1 = PacConv2d(256, 256, 3)

        self.reg_pac1 = PacConv2d(in_channels=256,
                                  out_channels=256,
                                  kernel_size=3,
                                  dilation=1)
    ...
    def forward_single(self, x, scale):
        ...
        reg_feat = x
        #if self.training:
        cls_feat = self.cls_pac1(cls_feat, x)
        reg_feat = self.reg_pac1(reg_feat, x)
